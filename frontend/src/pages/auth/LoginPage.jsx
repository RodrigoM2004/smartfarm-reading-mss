      ...
      <div className="flex flex-row items-center justify-center w-screen h-screen p-8">
        ...
        <div className=" h-full w-1/2 p-2 flex flex-col items-start justify-between pl-12 py-8">
              ...
              <div onClick={() => setIsLogin(true)}>
                <h1
                  className={`text-2xl font-bold ${
                    isLogin
                      ? "text-blue-950 border-transparent border-2"
                      : "text-gray-400 hover:border-b-blue-900 hover:text-blue-950 border-transparent border-2 transition-color duration-400 ease-in-out cursor-pointer"
                  }`}
                >
                  Entrar
                </h1>
          ...
          <div className="h-[15%] w-full flex flex-row items-center justify-between pt-12">
            <button
              className="bg-blue-950 text-white rounded-md px-8 py-2 cursor-pointer w-32 flex items-center justify-center"
