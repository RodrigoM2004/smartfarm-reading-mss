...
export function UserProvider({ children }) {
    ...
    const [dashboardFilterInitialData, setDashboardFilterInitialData] = useState(null)
    const [dashboardFilterFinalData, setDashboardFilterFinalData] = useState(null)
    ...
    const login = async (credentials) => {
        try{
            ...
            setDashboardFilterFinalData(userData?.sensors[0]?.readings[userData?.sensors[0]?.readings.length - 1]?.data)
